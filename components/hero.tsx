      ...
      <div className="grid md:grid-cols-3 gap-10 items-center max-w-6xl mx-auto">
        ...
        >
          ...
          <p className="text-muted-foreground text-sm sm:text-base">
            ...
            applications using modern technologies like React and more. Seeking
            to leverage my technical skills to deliver exceptional user
            experiences.
          </p>
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            ...
            <a href="https://instagram.com/ankit_tripathee" target="_blank">
              <Button
                ...
                className="text-xs sm:text-sm"
              >
                <RiInstagramLine className="h-3 w-3 sm:h-4 sm:w-4" />
              </Button>
            </a>
          </div>
        </motion.div>
